...
# specific data of interest for this type of extension point (tag details panel).
# ----------------------------------------------------------------------------------
class ZTagDetailsPanelDef(ZExtensionPointBaseDef):
    ...
    def getName(self):
        return self._getExtensionText(u"plg:tag-details-panel-info/plg:name") #$NON-NLS-1$
    # end getName()

# end ZTagDetailsPanelDef
